        ...
        contents: {
            ...
            body: {
                type: "box", layout: "vertical", contents: [
                    ...
                    createInfoRow("ใช้ได้ตั้งแต่", moment(guestAccessInfo.fromDate).format("DD/MM/YYYY HH:mm")),
                    createInfoRow("จนถึง", moment(guestAccessInfo.toDate).format("DD/MM/YYYY HH:mm")),
                    createInfoRow("สถานะ", status, statusColor),
                    createInfoRow("ประเภทผู้ใช้", guestType),
                    ...(status === "EXPIRED" ? [createExtendButton()] : [])
                ]
            }
        }
    };
